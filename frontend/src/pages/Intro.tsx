...
/**
 * Cinemática de apertura de NewsEra — se muestra siempre que se entra en
 * "/", con opción de saltarla en todo momento. La página de artículos vive
 * en /noticias (nunca "feed" de cara al usuario).
          ...
          >
            <div className="mx-auto grid w-full max-w-4xl grid-cols-1 items-center gap-6 sm:grid-cols-2 sm:gap-10">
              ...
              >
                ...
                <p className="pt-2 text-center text-[10px] text-zinc-400">Así se ve ahora mismo — toca para entrar</p>
              </Link>
            </div>
          </section>
        ))}
