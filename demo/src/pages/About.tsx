    ...
    <div className="relative">
      ...
      >
        ...
        <SlideShell {...memoria}>
          ...
          <Link
            to="/encuestas"
            className="mt-6 rounded-lg border border-white/30 bg-white/10 px-5 py-2.5 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20"
          >
            🙋 Ayúdanos contestando a una breve encuesta
          </Link>
